...
Note: This next part will be all about me explaining why I made this and some research I did beforehand. If you'd prefer to skip to the actual code, [please go here](#achievement-data). FIXTHIS
...
As somewhat of an achievement hunter (someone who likes to focus on collecting all achievements in a game), I thought it'd be fun and interesting to create an achievement plugin for UE5 that can sync with Steam and Epic games so people can easily make their own achievements at least locally and then also for Steam and/or Epic if they so choose. I wanted to post this to FAB eventually as well so that everyone would be able to use my plugin for achievements.

Not only would this teach me more about UE5's C++, but also how to make a plugin in there. I also would get to work with multiple SDKs, how FAB works, how to optimize my data management and hopefully much more.

Of course, I had to do reas
...
![](../assets/media/ILO1/achievementsSettings.png)  
...
```
![](../assets/media/ILO1/steamchiev.png)  
...
```
![](../assets/media/ILO1/epicchiev.png)  
___
### Popups
...
![](../assets/media/ILO1/defaultpopup.png)  
...
![](../assets/media/ILO1/popupgraph.png)  
...
![](../assets/media/ILO1/chievpopups.png)  
For an example of how it looks when animated, please check out the Show and Tell post I made about it that has a small .mp4: [link]([Comans, Justin (230772): Achievement Popups Queueing | 2025-26A FGA3.P1 > Show and Tell | Microsoft Teams](https://teams.microsoft.com/l/message/19:0193e00f062b4c108601ecbd187f377d@thread.tacv2/1759331348889?tenantId=0a33589b-0036-4fe8-a829-3ed0926af886&groupId=49dd43d9-df09-4faf-a41d-afd44002f9d6&parentMessageId=1759331348889&teamName=2025-26A%20FGA3.P1&channelName=Show%20and%20Tell&createdTime=1759331348889 "https://teams.microsoft.com/l/message/19:0193e00f062b4c108601ecbd187f377d@thread.tacv2/1759331348889?tenantId=0a33589b-0036-4fe8-a829-3ed0926af886&groupId=49dd43d9-df09-4faf-a41d-afd44002f9d6&parentMessageId=1759331348889&teamName=2025-26A%20FGA3.P1&channelName=Show%20and%20Tell&createdTime=1759331348889"))
___
### SaveGame and Config
